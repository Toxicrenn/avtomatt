...
@pytest.mark.positive
@pytest.mark.parametrize(
    "input_str, input_sym, expected",
    [("symbol", "s", True), ("tree", "d", False), ("New Year", "N", True)],
)
...
@pytest.mark.parametrize(
    "input_str, input_sym, expected",
    [("frozen", "n", "froze"), ("snow", "d", "snow"), ("lucky boy", " ", "luckyboy")],
)
...
@pytest.mark.parametrize(
    "input_str, input_sym, expected",
    [("party", "p", "party"), ("321456", "2", "21456"), ("Yyear", "y", "year")],
)
